/// Security Screen — Entry point for the VisionGo security system.
///
/// Presents a role-selection UI that lets the user choose between:
///   - **Camera** role: generates an 8-character pairing code and
///     navigates to [SecurityCameraScreen] to begin monitoring.
///   - **Monitor** role: accepts a pairing code and navigates to
///     [SecurityMonitorScreen] to receive real-time alerts.
///
/// The back button returns to the role-selection step if a role
/// has already been chosen, instead of popping the entire screen.
library;
...
/// Stateful widget managing role selection and pairing-code generation
...
class _SecurityScreenState extends State<SecurityScreen> {
  ...
  /// Generates a random 8-character alphanumeric pairing code
  ...
  /// Formats an 8-character code as "XXXX XXXX" for readability.
  ...
  /// Sets the device role to [role] and generates a pairing code
  /// if the camera role is selected.
  ...
  /// Validates the entered code and navigates to [SecurityMonitorScreen].
  void _pairDevice() {
  ...
  /// Navigates to [SecurityCameraScreen] with the generated pairing code.
  void _startCamera() {
