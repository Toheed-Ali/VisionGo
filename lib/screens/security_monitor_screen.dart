/// Security Monitor Screen — Receive real-time alerts from a paired camera.
///
/// This is the “monitor” side of VisionGo’s security system. It:
///   1. Validates the pairing code against Firebase.
///   2. Stores itself as a monitor device and saves its FCM token.
///   3. Streams alerts from Firebase and displays them in a real-time list.
///   4. Keeps background monitoring active even when the screen is popped.
///   5. Allows the user to unpair (disconnect) from the camera.
///
/// Alert items show the detected object label, confidence percentage,
/// relative time ("2m ago"), and a "NEW" badge for the latest alert.
library;
...
/// Stateful monitor screen that validates pairing, sets up a real-time
/// alert stream, and manages background monitoring lifecycle.
class SecurityMonitorScreen extends StatefulWidget {
  /// The 8-character pairing code from the camera device.
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              navigator.pop(); // Close monitor screen
