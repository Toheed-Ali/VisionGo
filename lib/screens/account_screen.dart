/// Account Screen — User profile, device management, and app information.
///
/// Displays the currently signed-in user's email, a truncated UID,
/// and an "Active Account" badge. Also embeds the
/// [ManageSecurityDevicesSection] for managing paired cameras/monitors.
///
/// Provides:
///   - About section showing app version, build number, and developer
...
/// Stateful account screen that loads the current Firebase user
...
class _AccountScreenState extends State<AccountScreen> {
  ...
  /// Loads the current [FirebaseAuth] user into state.
  ...
  /// Signs the user out after a confirmation dialog.
  ...
  /// Card showing user avatar (initial), email, UID, and status badge.
  ...
  /// Section listing app version, build number, and developer,
  /// with a "View Licenses" button.
  ...
  /// Single key/value row inside the about section.
  ...
  /// Full-width red-outlined sign-out button.
  ...
  /// Shows an about-dialog with version and copyright information.
