/// Object Detection Screen — YOLO inference on a gallery image.
///
/// Loads the selected [AssetEntity] image, displays it with a Hero
/// animation, and runs [YoloDetector.detectObjects] to find objects.
/// Results are rendered as:
///   - Bounding boxes via [DetectionPainter] on top of the image
///   - A scrollable list of detection cards showing label, confidence,
///     and colour-coded index
///
/// Provides a retry button if detection fails or returns zero results.
library;
...
/// Stateful screen that loads a gallery image and performs YOLO
/// object detection, displaying bounding boxes and a results list.
class ObjectDetectionScreen extends StatefulWidget {
  /// The gallery asset to analyse.
...
///
/// Correctly maps coordinates from the original [imageSize] to the
/// on-screen [containerSize] using aspect-ratio-aware scaling.
